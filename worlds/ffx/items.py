...
overdrive_items: list[ItemData] = [ItemData(x[0], x[1], x[2] | overdriveItemOffset) for x in [
    ...
    ("Reels: Element Reels",        ItemClassification.progression, 0x0074),
    ("Reels: Attack Reels",         ItemClassification.progression, 0x0075),
    ("Reels: Status Reels",         ItemClassification.progression, 0x0076),
    ("Reels: Aurochs Reels",        ItemClassification.progression, 0x0077),
