...
normal_items: list[tuple[str, ItemClassification, int, int, int, int]] = [
    ("Potion",               ItemClassification.filler, 0x0000, 5, 99, 50),
    ("Hi-Potion",            ItemClassification.filler, 0x0001, 5, 99, 50),
    ("X-Potion",             ItemClassification.filler, 0x0002, 5, 99, 50),
    ("Mega-Potion",          ItemClassification.filler, 0x0003, 5, 99, 50),
    ("Ether",                ItemClassification.filler, 0x0004, 5, 99, 50),
    ("Turbo Ether",          ItemClassification.filler, 0x0005, 5, 99, 50),
    ("Phoenix Down",         ItemClassification.filler, 0x0006, 5, 99, 50),
    ("Mega Phoenix",         ItemClassification.useful, 0x0007, 5, 99, 50),
    ("Elixir",               ItemClassification.filler, 0x0008, 5, 99, 50),
    ("Megalixir",            ItemClassification.filler, 0x0009, 5, 99, 50),
    ("Antidote",             ItemClassification.filler, 0x000A, 5, 99, 50),
    ("Soft",                 ItemClassification.filler, 0x000B, 5, 99, 50),
    ("Eye Drops",            ItemClassification.filler, 0x000C, 5, 99, 50),
    ("Echo Screen",          ItemClassification.filler, 0x000D, 5, 99, 50),
    ("Holy Water",           ItemClassification.filler, 0x000E, 5, 99, 50),
    ("Remedy",               ItemClassification.filler, 0x000F, 5, 99, 50),
  # ("Power Distiller",      ItemClassification.useful, 0x0010, 5, 99, 50),
  # ("Mana Distiller",       ItemClassification.useful, 0x0011, 5, 99, 50),
  # ("Speed Distiller",      ItemClassification.useful, 0x0012, 5, 99, 50),
  # ("Ability Distiller",    ItemClassification.useful, 0x0013, 5, 99, 50),
    ("Al Bhed Potion",       ItemClassification.useful, 0x0014, 5, 99, 50),
    ("Healing Water",        ItemClassification.useful, 0x0015, 5, 99, 50),
    ("Tetra Elemental",      ItemClassification.useful, 0x0016, 5, 99, 50),
    ("Antarctic Wind",       ItemClassification.useful, 0x0017, 5, 99, 50),
    ("Arctic Wind",          ItemClassification.useful, 0x0018, 5, 99, 50),
    ("Ice Gem",              ItemClassification.useful, 0x0019, 5, 99, 50),
    ("Bomb Fragment",        ItemClassification.useful, 0x001A, 5, 99, 50),
    ("Bomb Core",            ItemClassification.useful, 0x001B, 5, 99, 50),
    ("Fire Gem",             ItemClassification.useful, 0x001C, 5, 99, 50),
    ("Electro Marble",       ItemClassification.useful, 0x001D, 5, 99, 50),
    ("Lightning Marble",     ItemClassification.useful, 0x001E, 5, 99, 50),
    ("Lightning Gem",        ItemClassification.useful, 0x001F, 5, 99, 50),
    ("Fish Scale",           ItemClassification.useful, 0x0020, 5, 99, 50),
    ("Dragon Scale",         ItemClassification.useful, 0x0021, 5, 99, 50),
    ("Water Gem",            ItemClassification.useful, 0x0022, 5, 99, 50),
    ("Grenade",              ItemClassification.useful, 0x0023, 5, 99, 50),
    ("Frag Grenade",         ItemClassification.useful, 0x0024, 5, 99, 50),
    ("Sleeping Powder",      ItemClassification.useful, 0x0025, 5, 99, 50),
    ("Dream Powder",         ItemClassification.useful, 0x0026, 5, 99, 50),
    ("Silence Grenade",      ItemClassification.useful, 0x0027, 5, 99, 50),
    ("Smoke Bomb",           ItemClassification.useful, 0x0028, 5, 99, 50),
    ("Shadow Gem",           ItemClassification.useful, 0x0029, 5, 99, 50),
    ("Shining Gem",          ItemClassification.useful, 0x002A, 5, 99, 50),
    ("Blessed Gem",          ItemClassification.useful, 0x002B, 5, 99, 50),
    ("Supreme Gem",          ItemClassification.useful, 0x002C, 5, 99, 50),
    ("Poison Fang",          ItemClassification.useful, 0x002D, 5, 99, 50),
    ("Silver Hourglass",     ItemClassification.useful, 0x002E, 5, 99, 50),
    ("Gold Hourglass",       ItemClassification.useful, 0x002F, 5, 99, 50),
    ("Candle of Life",       ItemClassification.useful, 0x0030, 5, 99, 50),
    ("Petrify Grenade",      ItemClassification.useful, 0x0031, 5, 99, 50),
    ("Farplane Shadow",      ItemClassification.useful, 0x0032, 5, 99, 50),
    ("Farplane Wind",        ItemClassification.useful, 0x0033, 5, 99, 50),
    ("[Designer Wallet]",    ItemClassification.useful, 0x0034, 5, 99, 50),
    ("Dark Matter",          ItemClassification.useful, 0x0035, 5, 99, 50),
    ("Chocobo Feather",      ItemClassification.useful, 0x0036, 5, 99, 50),
    ("Chocobo Wing",         ItemClassification.useful, 0x0037, 5, 99, 50),
    ("Lunar Curtain",        ItemClassification.useful, 0x0038, 5, 99, 50),
    ("Light Curtain",        ItemClassification.useful, 0x0039, 5, 99, 50),
    ("Star Curtain",         ItemClassification.useful, 0x003A, 5, 99, 50),
    ("Healing Spring",       ItemClassification.useful, 0x003B, 5, 99, 50),
    ("Mana Spring",          ItemClassification.useful, 0x003C, 5, 99, 50),
    ("Stamina Spring",       ItemClassification.useful, 0x003D, 5, 99, 50),
    ("Soul Spring",          ItemClassification.useful, 0x003E, 5, 99, 50),
    ("Purifying Salt",       ItemClassification.useful, 0x003F, 5, 99, 50),
    ("Stamina Tablet",       ItemClassification.useful, 0x0040, 5, 99, 50),
    ("Mana Tablet",          ItemClassification.useful, 0x0041, 5, 99, 50),
    ("Twin Stars",           ItemClassification.useful, 0x0042, 5, 99, 50),
    ("Stamina Tonic",        ItemClassification.useful, 0x0043, 5, 99, 50),
    ("Mana Tonic",           ItemClassification.useful, 0x0044, 5, 99, 50),
    ("Three Stars",          ItemClassification.useful, 0x0045, 5, 99, 50),
   #("[Power Sphere]",       ItemClassification.useful, 0x0046, 5, 99, 50), # Infinite supply
   #("[Mana Sphere]",        ItemClassification.useful, 0x0047, 5, 99, 50), # Infinite supply
   #("[Speed Sphere]",       ItemClassification.useful, 0x0048, 5, 99, 50), # Infinite supply
   #("[Ability Sphere]",     ItemClassification.useful, 0x0049, 5, 99, 50), # Infinite supply
    ("[Fortune Sphere]",     ItemClassification.useful, 0x004A, 5, 99, 50),
    ("[Attribute Sphere]",   ItemClassification.useful, 0x004B, 5, 99, 50),
    ("[Special Sphere]",     ItemClassification.useful, 0x004C, 5, 99, 50),
    ("[Skill Sphere]",       ItemClassification.useful, 0x004D, 5, 99, 50),
    ("[Wht Magic Sphere]",   ItemClassification.useful, 0x004E, 5, 99, 50),
    ("[Blk Magic Sphere]",   ItemClassification.useful, 0x004F, 5, 99, 50),
    ("[Master Sphere]",      ItemClassification.useful, 0x0050, 5, 99, 50),
    ("[Lv. 1 Key Sphere]",   ItemClassification.useful, 0x0051, 5, 99, 50),
    ("[Lv. 2 Key Sphere]",   ItemClassification.useful, 0x0052, 5, 99, 50),
    ("[Lv. 3 Key Sphere]",   ItemClassification.useful, 0x0053, 5, 99, 50),
    ("[Lv. 4 Key Sphere]",   ItemClassification.useful, 0x0054, 5, 99, 50),
    ("[HP Sphere]",          ItemClassification.useful, 0x0055, 5, 99, 50),
    ("[MP Sphere]",          ItemClassification.useful, 0x0056, 5, 99, 50),
    ("[Strength Sphere]",    ItemClassification.useful, 0x0057, 5, 99, 50),
    ("[Defense Sphere]",     ItemClassification.useful, 0x0058, 5, 99, 50),
    ("[Magic Sphere]",       ItemClassification.useful, 0x0059, 5, 99, 50),
    ("[Magic Def Sphere]",   ItemClassification.useful, 0x005A, 5, 99, 50),
    ("[Agility Sphere]",     ItemClassification.useful, 0x005B, 5, 99, 50),
    ("[Evasion Sphere]",     ItemClassification.useful, 0x005C, 5, 99, 50),
    ("[Accuracy Sphere]",    ItemClassification.useful, 0x005D, 5, 99, 50),
    ("[Luck Sphere]",        ItemClassification.useful, 0x005E, 5, 99, 50),
    ("[Clear Sphere]",       ItemClassification.useful, 0x005F, 5, 99, 50),
    ("[Return Sphere]",      ItemClassification.useful, 0x0060, 5, 99, 50),
    ("[Friend Sphere]",      ItemClassification.useful, 0x0061, 5, 99, 50),
    ("[Teleport Sphere]",    ItemClassification.useful, 0x0062, 5, 99, 50),
    ("[Warp Sphere]",        ItemClassification.useful, 0x0063, 5, 99, 50),
    ("[Map]",                ItemClassification.useful, 0x0064, 5, 99, 50),
    ("[Rename Card]",        ItemClassification.useful, 0x0065, 5, 99, 50),
    ("[Musk]",               ItemClassification.useful, 0x0066, 5, 99, 50),
    ("[Hypello Potion]",     ItemClassification.useful, 0x0067, 5, 99, 50),
    ("[Shining Thorn]",      ItemClassification.useful, 0x0068, 5, 99, 50),
    ("[Pendulum]",           ItemClassification.useful, 0x0069, 5, 99, 50),
    ("[Amulet]",             ItemClassification.useful, 0x006A, 5, 99, 50),
    ("[Door to Tomorrow]",   ItemClassification.useful, 0x006B, 5, 99, 50),
    ("[Wings to Discovery]", ItemClassification.useful, 0x006C, 5, 99, 50),
    ("[Gambler's Spirit]",   ItemClassification.useful, 0x006D, 5, 99, 50),
    ("[Underdog's Secret]",  ItemClassification.useful, 0x006E, 5, 99, 50),
    ("[Winning Formula]",    ItemClassification.useful, 0x006F, 5, 99, 50),
]

generated_normal_items: list[ItemData] = [ItemData(f"{x[0]} x {i}" if i > 1 else x[0], x[1], x[2] | normalItemOffset | (i << 16)) for i in range(1, 100, 1) for x in normal_items]
