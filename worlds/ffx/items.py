...
other_items: list[ItemData] = [ItemData(x[0], x[1], x[2] | otherItemOffset) for x in [
    ("Gear Customization: Sensor",             ItemClassification.useful, 0x0000),
    ...
    ("Gear Customization: Fire Ward",          ItemClassification.useful, 0x0005),
    ...
    ("Gear Customization: Lightning Ward",     ItemClassification.useful, 0x0009),
    ...
    ("Gear Customization: Water Ward",         ItemClassification.useful, 0x000D),
    ...
    ("Gear Customization: Ice Ward",           ItemClassification.useful, 0x0011),
    ...
    ("Gear Customization: Dark Ward",          ItemClassification.useful, 0x0016),
    ...
    ("Gear Customization: Silence Ward",       ItemClassification.useful, 0x001A),
    ...
    ("Gear Customization: Sleep Ward",         ItemClassification.useful, 0x001E),
    ...
    ("Gear Customization: Poison Ward",        ItemClassification.useful, 0x0022),
    ...
    ("Gear Customization: Zombie Ward",        ItemClassification.useful, 0x002E),
    ...
    ("Gear Customization: Slow Ward",          ItemClassification.useful, 0x0032),
    ...
    ("Gear Customization: Berserk Ward",       ItemClassification.useful, 0x0036),
    ...
    ("Gear Customization: SOS Shell",          ItemClassification.useful, 0x0041),
    ("Gear Customization: SOS Protect",        ItemClassification.useful, 0x0042),
    ...
    ("Gear Customization: Strength +3%",       ItemClassification.useful, 0x004B),
    ("Gear Customization: Strength +5%",       ItemClassification.useful, 0x004C),
    ...
    ("Gear Customization: Magic +3%",          ItemClassification.useful, 0x004F),
    ("Gear Customization: Magic +5%",          ItemClassification.useful, 0x0050),
    ("Gear Customization: Magic +10%",         ItemClassification.useful, 0x0051),
    ("Gear Customization: Magic +20%",         ItemClassification.useful, 0x0052),
    ("Gear Customization: Defense +3%",        ItemClassification.useful, 0x0053),
    ("Gear Customization: Defense +5%",        ItemClassification.useful, 0x0054),
    ...
    ("Gear Customization: Magic Def +3%",      ItemClassification.useful, 0x0057),
    ("Gear Customization: Magic Def +5%",      ItemClassification.useful, 0x0058),
    ...
    ("Gear Customization: HP +5%",             ItemClassification.useful, 0x005B),
    ("Gear Customization: HP +10%",            ItemClassification.useful, 0x005C),
    ("Gear Customization: HP +20%",            ItemClassification.useful, 0x005D),
    ("Gear Customization: HP +30%",            ItemClassification.useful, 0x005E),
    ("Gear Customization: MP +5%",             ItemClassification.useful, 0x005F),
    ("Gear Customization: MP +10%",            ItemClassification.useful, 0x0060),
    ...
    ("Gear Customization: HP Stroll",          ItemClassification.useful, 0x0076),
    ("Gear Customization: MP Stroll",          ItemClassification.useful, 0x0077),
    ...
    ("Aeon Customization: Pray",            ItemClassification.useful, 0x0013 + 0x7D),
    ("Aeon Customization: Cheer",           ItemClassification.useful, 0x0014 + 0x7D),
    ("Aeon Customization: Aim",             ItemClassification.useful, 0x0015 + 0x7D),
    ("Aeon Customization: Focus",           ItemClassification.useful, 0x0016 + 0x7D),
    ("Aeon Customization: Reflex",          ItemClassification.useful, 0x0017 + 0x7D),
    ("Aeon Customization: Luck",            ItemClassification.useful, 0x0018 + 0x7D),
    ("Aeon Customization: Jinx",            ItemClassification.useful, 0x0019 + 0x7D),
    ("Aeon Customization: Lancet",          ItemClassification.useful, 0x001A + 0x7D),
    ...
    ("Aeon Customization: Scan",            ItemClassification.useful, 0x0023 + 0x7D),
