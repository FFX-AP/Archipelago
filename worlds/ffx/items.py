...
other_items: list[ItemData] = [ItemData(x[0], x[1], x[2] | otherItemOffset) for x in [
    ...
    ("Gear Customization: Stone Ward",         ItemClassification.filler, 0x0026),
    ...
    ("Gear Customization: Death Ward",         ItemClassification.filler, 0x002A),
    ...
    ("Gear Customization: Confuse Ward",       ItemClassification.filler, 0x0034),
    ...
    ("Gear Customization: SOS Regen",          ItemClassification.useful, 0x0045),
    ...
    ("Gear Customization: Gillionaire",        ItemClassification.filler, 0x0073),
