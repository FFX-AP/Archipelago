...
class NormalItemData(NamedTuple):
    itemName: str
    progression: ItemClassification
    itemID: int = 0x00
    min: int = 5
...
# name, classification, id, min, max, weight
normal_items: list[NormalItemData] = [
    NormalItemData("Potion",               ItemClassification.filler, 0x0000, 5, 99, 50),
    NormalItemData("Hi-Potion",            ItemClassification.filler, 0x0001, 5, 99, 50),
    NormalItemData("X-Potion",             ItemClassification.filler, 0x0002, 5, 99, 50),
    NormalItemData("Mega-Potion",          ItemClassification.filler, 0x0003, 5, 99, 50),
    NormalItemData("Ether",                ItemClassification.filler, 0x0004, 5, 99, 50),
    NormalItemData("Turbo Ether",          ItemClassification.filler, 0x0005, 5, 99, 50),
    NormalItemData("Phoenix Down",         ItemClassification.filler, 0x0006, 5, 99, 50),
    NormalItemData("Mega Phoenix",         ItemClassification.useful, 0x0007, 5, 99, 50),
    NormalItemData("Elixir",               ItemClassification.filler, 0x0008, 5, 99, 50),
    NormalItemData("Megalixir",            ItemClassification.filler, 0x0009, 5, 99, 50),
    NormalItemData("Antidote",             ItemClassification.filler, 0x000A, 5, 99, 50),
    NormalItemData("Soft",                 ItemClassification.filler, 0x000B, 5, 99, 50),
    NormalItemData("Eye Drops",            ItemClassification.filler, 0x000C, 5, 99, 50),
    NormalItemData("Echo Screen",          ItemClassification.filler, 0x000D, 5, 99, 50),
    NormalItemData("Holy Water",           ItemClassification.filler, 0x000E, 5, 99, 50),
    NormalItemData("Remedy",               ItemClassification.filler, 0x000F, 5, 99, 50),
  # NormalItemData("Power Distiller",      ItemClassification.useful, 0x0010, 5, 99, 50),
  # NormalItemData("Mana Distiller",       ItemClassification.useful, 0x0011, 5, 99, 50),
  # NormalItemData("Speed Distiller",      ItemClassification.useful, 0x0012, 5, 99, 50),
  # NormalItemData("Ability Distiller",    ItemClassification.useful, 0x0013, 5, 99, 50),
    NormalItemData("Al Bhed Potion",       ItemClassification.useful, 0x0014, 5, 99, 50),
    NormalItemData("Healing Water",        ItemClassification.useful, 0x0015, 5, 99, 50),
    NormalItemData("Tetra Elemental",      ItemClassification.useful, 0x0016, 5, 99, 50),
    NormalItemData("Antarctic Wind",       ItemClassification.useful, 0x0017, 5, 99, 50),
    NormalItemData("Arctic Wind",          ItemClassification.useful, 0x0018, 5, 99, 50),
    NormalItemData("Ice Gem",              ItemClassification.useful, 0x0019, 5, 99, 50),
    NormalItemData("Bomb Fragment",        ItemClassification.useful, 0x001A, 5, 99, 50),
    NormalItemData("Bomb Core",            ItemClassification.useful, 0x001B, 5, 99, 50),
    NormalItemData("Fire Gem",             ItemClassification.useful, 0x001C, 5, 99, 50),
    NormalItemData("Electro Marble",       ItemClassification.useful, 0x001D, 5, 99, 50),
    NormalItemData("Lightning Marble",     ItemClassification.useful, 0x001E, 5, 99, 50),
    NormalItemData("Lightning Gem",        ItemClassification.useful, 0x001F, 5, 99, 50),
    NormalItemData("Fish Scale",           ItemClassification.useful, 0x0020, 5, 99, 50),
    NormalItemData("Dragon Scale",         ItemClassification.useful, 0x0021, 5, 99, 50),
    NormalItemData("Water Gem",            ItemClassification.useful, 0x0022, 5, 99, 50),
    NormalItemData("Grenade",              ItemClassification.useful, 0x0023, 5, 99, 50),
    NormalItemData("Frag Grenade",         ItemClassification.useful, 0x0024, 5, 99, 50),
    NormalItemData("Sleeping Powder",      ItemClassification.useful, 0x0025, 5, 99, 50),
    NormalItemData("Dream Powder",         ItemClassification.useful, 0x0026, 5, 99, 50),
    NormalItemData("Silence Grenade",      ItemClassification.useful, 0x0027, 5, 99, 50),
    NormalItemData("Smoke Bomb",           ItemClassification.useful, 0x0028, 5, 99, 50),
    NormalItemData("Shadow Gem",           ItemClassification.useful, 0x0029, 5, 99, 50),
    NormalItemData("Shining Gem",          ItemClassification.useful, 0x002A, 5, 99, 50),
    NormalItemData("Blessed Gem",          ItemClassification.useful, 0x002B, 5, 99, 50),
    NormalItemData("Supreme Gem",          ItemClassification.useful, 0x002C, 5, 99, 50),
    NormalItemData("Poison Fang",          ItemClassification.useful, 0x002D, 5, 99, 50),
    NormalItemData("Silver Hourglass",     ItemClassification.useful, 0x002E, 5, 99, 50),
    NormalItemData("Gold Hourglass",       ItemClassification.useful, 0x002F, 5, 99, 50),
    NormalItemData("Candle of Life",       ItemClassification.useful, 0x0030, 5, 99, 50),
    NormalItemData("Petrify Grenade",      ItemClassification.useful, 0x0031, 5, 99, 50),
    NormalItemData("Farplane Shadow",      ItemClassification.useful, 0x0032, 5, 99, 50),
    NormalItemData("Farplane Wind",        ItemClassification.useful, 0x0033, 5, 99, 50),
    NormalItemData("[Designer Wallet]",    ItemClassification.useful, 0x0034, 5, 99, 50),
    NormalItemData("Dark Matter",          ItemClassification.useful, 0x0035, 5, 99, 50),
    NormalItemData("Chocobo Feather",      ItemClassification.useful, 0x0036, 5, 99, 50),
    NormalItemData("Chocobo Wing",         ItemClassification.useful, 0x0037, 5, 99, 50),
    NormalItemData("Lunar Curtain",        ItemClassification.useful, 0x0038, 5, 99, 50),
    NormalItemData("Light Curtain",        ItemClassification.useful, 0x0039, 5, 99, 50),
    NormalItemData("Star Curtain",         ItemClassification.useful, 0x003A, 5, 99, 50),
    NormalItemData("Healing Spring",       ItemClassification.useful, 0x003B, 5, 99, 50),
    NormalItemData("Mana Spring",          ItemClassification.useful, 0x003C, 5, 99, 50),
    NormalItemData("Stamina Spring",       ItemClassification.useful, 0x003D, 5, 99, 50),
    NormalItemData("Soul Spring",          ItemClassification.useful, 0x003E, 5, 99, 50),
    NormalItemData("Purifying Salt",       ItemClassification.useful, 0x003F, 5, 99, 50),
    NormalItemData("Stamina Tablet",       ItemClassification.useful, 0x0040, 5, 99, 50),
    NormalItemData("Mana Tablet",          ItemClassification.useful, 0x0041, 5, 99, 50),
    NormalItemData("Twin Stars",           ItemClassification.useful, 0x0042, 5, 99, 50),
    NormalItemData("Stamina Tonic",        ItemClassification.useful, 0x0043, 5, 99, 50),
    NormalItemData("Mana Tonic",           ItemClassification.useful, 0x0044, 5, 99, 50),
    NormalItemData("Three Stars",          ItemClassification.useful, 0x0045, 5, 99, 50),
   #NormalItemData("[Power Sphere]",       ItemClassification.useful, 0x0046, 5, 99, 50), # Infinite supply
   #NormalItemData("[Mana Sphere]",        ItemClassification.useful, 0x0047, 5, 99, 50), # Infinite supply
   #NormalItemData("[Speed Sphere]",       ItemClassification.useful, 0x0048, 5, 99, 50), # Infinite supply
   #NormalItemData("[Ability Sphere]",     ItemClassification.useful, 0x0049, 5, 99, 50), # Infinite supply
    NormalItemData("[Fortune Sphere]",     ItemClassification.useful, 0x004A, 5, 99, 50),
    NormalItemData("[Attribute Sphere]",   ItemClassification.useful, 0x004B, 5, 99, 50),
    NormalItemData("[Special Sphere]",     ItemClassification.useful, 0x004C, 5, 99, 50),
    NormalItemData("[Skill Sphere]",       ItemClassification.useful, 0x004D, 5, 99, 50),
    NormalItemData("[Wht Magic Sphere]",   ItemClassification.useful, 0x004E, 5, 99, 50),
    NormalItemData("[Blk Magic Sphere]",   ItemClassification.useful, 0x004F, 5, 99, 50),
    NormalItemData("[Master Sphere]",      ItemClassification.useful, 0x0050, 5, 99, 50),
    NormalItemData("[Lv. 1 Key Sphere]",   ItemClassification.useful, 0x0051, 5, 99, 50),
    NormalItemData("[Lv. 2 Key Sphere]",   ItemClassification.useful, 0x0052, 5, 99, 50),
    NormalItemData("[Lv. 3 Key Sphere]",   ItemClassification.useful, 0x0053, 5, 99, 50),
    NormalItemData("[Lv. 4 Key Sphere]",   ItemClassification.useful, 0x0054, 5, 99, 50),
    NormalItemData("[HP Sphere]",          ItemClassification.useful, 0x0055, 5, 99, 50),
    NormalItemData("[MP Sphere]",          ItemClassification.useful, 0x0056, 5, 99, 50),
    NormalItemData("[Strength Sphere]",    ItemClassification.useful, 0x0057, 5, 99, 50),
    NormalItemData("[Defense Sphere]",     ItemClassification.useful, 0x0058, 5, 99, 50),
    NormalItemData("[Magic Sphere]",       ItemClassification.useful, 0x0059, 5, 99, 50),
    NormalItemData("[Magic Def Sphere]",   ItemClassification.useful, 0x005A, 5, 99, 50),
    NormalItemData("[Agility Sphere]",     ItemClassification.useful, 0x005B, 5, 99, 50),
    NormalItemData("[Evasion Sphere]",     ItemClassification.useful, 0x005C, 5, 99, 50),
    NormalItemData("[Accuracy Sphere]",    ItemClassification.useful, 0x005D, 5, 99, 50),
    NormalItemData("[Luck Sphere]",        ItemClassification.useful, 0x005E, 5, 99, 50),
    NormalItemData("[Clear Sphere]",       ItemClassification.useful, 0x005F, 5, 99, 50),
    NormalItemData("[Return Sphere]",      ItemClassification.useful, 0x0060, 5, 99, 50),
    NormalItemData("[Friend Sphere]",      ItemClassification.useful, 0x0061, 5, 99, 50),
    NormalItemData("[Teleport Sphere]",    ItemClassification.useful, 0x0062, 5, 99, 50),
    NormalItemData("[Warp Sphere]",        ItemClassification.useful, 0x0063, 5, 99, 50),
    NormalItemData("[Map]",                ItemClassification.useful, 0x0064, 5, 99, 50),
    NormalItemData("[Rename Card]",        ItemClassification.useful, 0x0065, 5, 99, 50),
    NormalItemData("[Musk]",               ItemClassification.useful, 0x0066, 5, 99, 50),
    NormalItemData("[Hypello Potion]",     ItemClassification.useful, 0x0067, 5, 99, 50),
    NormalItemData("[Shining Thorn]",      ItemClassification.useful, 0x0068, 5, 99, 50),
    NormalItemData("[Pendulum]",           ItemClassification.useful, 0x0069, 5, 99, 50),
    NormalItemData("[Amulet]",             ItemClassification.useful, 0x006A, 5, 99, 50),
    NormalItemData("[Door to Tomorrow]",   ItemClassification.useful, 0x006B, 5, 99, 50),
    NormalItemData("[Wings to Discovery]", ItemClassification.useful, 0x006C, 5, 99, 50),
    NormalItemData("[Gambler's Spirit]",   ItemClassification.useful, 0x006D, 5, 99, 50),
    NormalItemData("[Underdog's Secret]",  ItemClassification.useful, 0x006E, 5, 99, 50),
    NormalItemData("[Winning Formula]",    ItemClassification.useful, 0x006F, 5, 99, 50),
]

generated_normal_items: list[ItemData] = [ItemData(f"{x.itemName} x {i}" if i > 1 else x.itemName, x.progression, x.itemID | normalItemOffset | (i << 16)) for i in range(1, 100, 1) for x in normal_items]
...
key_items: list[ItemData] = [ItemData(x[0], x[1], x[2] | keyItemOffset) for x in [
    ...
    ("Progressive Mirror",          ItemClassification.progression, 0x0002),
  # ("Celestial Mirror",            ItemClassification.progression, 0x0003),
    ("Progressive Al Bhed Primer",  ItemClassification.progression, 0x0004),
  ...
  # ("Al Bhed Primer XXVI",         ItemClassification.progression, 0x001D),
    ...
    ("Progressive Jecht's Sphere",  ItemClassification.progression, 0x0020),
...
overdrive_items: list[ItemData] = [ItemData(x[0], x[1], x[2] | overdriveItemOffset) for x in [
    ("Swordplay: Spiral Cut",       ItemClassification.progression, 0x0060),
    ("Swordplay: Slice and Dice",   ItemClassification.progression, 0x0061),
    ("Swordplay: Energy Rain",      ItemClassification.progression, 0x0062),
    ("Swordplay: Blitz Ace",        ItemClassification.progression, 0x0063),
    ("Bushido: Shooting Star",      ItemClassification.progression, 0x0064),
    ("Bushido: Dragon Fang",        ItemClassification.progression, 0x0065),
    ("Bushido: Banishing Blade",    ItemClassification.progression, 0x0066),
    ("Bushido: Tornado",            ItemClassification.progression, 0x0067),
    ...
    ("Slots: Element Reels",        ItemClassification.progression, 0x0074),
    ("Slots: Attack Reels",         ItemClassification.progression, 0x0075),
    ("Slots: Status Reels",         ItemClassification.progression, 0x0076),
    ("Slots: Aurochs Reels",        ItemClassification.progression, 0x0077),
...
other_items: list[ItemData] = [ItemData(x[0], x[1], x[2] | otherItemOffset) for x in [
    ("Gear Customization: Sensor",             ItemClassification.filler, 0x0000),
    ("Gear Customization: Piercing",           ItemClassification.useful, 0x0001),
    ("Gear Customization: First Strike",       ItemClassification.useful, 0x0002),
    ("Gear Customization: Initiative",         ItemClassification.useful, 0x0003),
    ("Gear Customization: Firestrike",         ItemClassification.useful, 0x0004),
    ("Gear Customization: Fire Ward",          ItemClassification.filler, 0x0005),
    ("Gear Customization: Fireproof",          ItemClassification.useful, 0x0006),
    ("Gear Customization: Fire Eater",         ItemClassification.useful, 0x0007),
    ("Gear Customization: Lightningstrike",    ItemClassification.useful, 0x0008),
    ("Gear Customization: Lightning Ward",     ItemClassification.filler, 0x0009),
    ("Gear Customization: Lightningproof",     ItemClassification.useful, 0x000A),
    ("Gear Customization: Lightning Eater",    ItemClassification.useful, 0x000B),
    ("Gear Customization: Waterstrike",        ItemClassification.useful, 0x000C),
    ("Gear Customization: Water Ward",         ItemClassification.filler, 0x000D),
    ("Gear Customization: Waterproof",         ItemClassification.useful, 0x000E),
    ("Gear Customization: Water Eater",        ItemClassification.useful, 0x000F),
    ("Gear Customization: Icestrike",          ItemClassification.useful, 0x0010),
    ("Gear Customization: Ice Ward",           ItemClassification.filler, 0x0011),
    ("Gear Customization: Iceproof",           ItemClassification.useful, 0x0012),
    ("Gear Customization: Ice Eater",          ItemClassification.useful, 0x0013),
    ("Gear Customization: Darktouch",          ItemClassification.useful, 0x0014),
    ("Gear Customization: Darkstrike",         ItemClassification.useful, 0x0015),
    ("Gear Customization: Dark Ward",          ItemClassification.filler, 0x0016),
    ("Gear Customization: Darkproof",          ItemClassification.useful, 0x0017),
    ("Gear Customization: Silencetouch",       ItemClassification.useful, 0x0018),
    ("Gear Customization: Silencestrike",      ItemClassification.useful, 0x0019),
    ("Gear Customization: Silence Ward",       ItemClassification.filler, 0x001A),
    ("Gear Customization: Silenceproof",       ItemClassification.useful, 0x001B),
    ("Gear Customization: Sleeptouch",         ItemClassification.useful, 0x001C),
    ("Gear Customization: Sleepstrike",        ItemClassification.useful, 0x001D),
    ("Gear Customization: Sleep Ward",         ItemClassification.filler, 0x001E),
    ("Gear Customization: Sleepproof",         ItemClassification.useful, 0x001F),
    ("Gear Customization: Poisontouch",        ItemClassification.useful, 0x0020),
    ("Gear Customization: Poisonstrike",       ItemClassification.useful, 0x0021),
    ("Gear Customization: Poison Ward",        ItemClassification.filler, 0x0022),
    ("Gear Customization: Poisonproof",        ItemClassification.useful, 0x0023),
    ("Gear Customization: Stonetouch",         ItemClassification.useful, 0x0024),
    ("Gear Customization: Stonestrike",        ItemClassification.useful, 0x0025),
    ("Gear Customization: Stone Ward",         ItemClassification.useful, 0x0026),
    ("Gear Customization: Stoneproof",         ItemClassification.useful, 0x0027),
    ("Gear Customization: Deathtouch",         ItemClassification.useful, 0x0028),
    ("Gear Customization: Deathstrike",        ItemClassification.useful, 0x0029),
    ("Gear Customization: Death Ward",         ItemClassification.useful, 0x002A),
    ("Gear Customization: Deathproof",         ItemClassification.useful, 0x002B),
    ("Gear Customization: Zombietouch",        ItemClassification.useful, 0x002C),
    ("Gear Customization: Zombiestrike",       ItemClassification.useful, 0x002D),
    ("Gear Customization: Zombie Ward",        ItemClassification.filler, 0x002E),
    ("Gear Customization: Zombieproof",        ItemClassification.useful, 0x002F),
    ("Gear Customization: Slowtouch",          ItemClassification.useful, 0x0030),
    ("Gear Customization: Slowstrike",         ItemClassification.useful, 0x0031),
    ("Gear Customization: Slow Ward",          ItemClassification.filler, 0x0032),
    ("Gear Customization: Slowproof",          ItemClassification.useful, 0x0033),
    ("Gear Customization: Confuse Ward",       ItemClassification.useful, 0x0034),
    ("Gear Customization: Confuseproof",       ItemClassification.useful, 0x0035),
    ("Gear Customization: Berserk Ward",       ItemClassification.filler, 0x0036),
    ("Gear Customization: Berserkproof",       ItemClassification.useful, 0x0037),
    ("Gear Customization: Curseproof",         ItemClassification.useful, 0x0038),
    # ("Gear Customization: Distill Power",      ItemClassification.useful, 0x0039),
    # ("Gear Customization: Distill Mana",       ItemClassification.useful, 0x003A),
    # ("Gear Customization: Distill Speed",      ItemClassification.useful, 0x003B),
    # ("Gear Customization: Distill Ability",    ItemClassification.useful, 0x003C),
    ("Gear Customization: SOS NulBlaze",       ItemClassification.useful, 0x003D),
    ("Gear Customization: SOS NulShock",       ItemClassification.useful, 0x003E),
    ("Gear Customization: SOS NulTide",        ItemClassification.useful, 0x003F),
    ("Gear Customization: SOS NulFrost",       ItemClassification.useful, 0x0040),
    ("Gear Customization: SOS Shell",          ItemClassification.filler, 0x0041),
    ("Gear Customization: SOS Protect",        ItemClassification.filler, 0x0042),
    ("Gear Customization: SOS Reflect",        ItemClassification.useful, 0x0043),
    ("Gear Customization: SOS Haste",          ItemClassification.useful, 0x0044),
    ("Gear Customization: SOS Regen",          ItemClassification.filler, 0x0045),
    ("Gear Customization: Auto-Shell",         ItemClassification.useful, 0x0046),
    ("Gear Customization: Auto-Protect",       ItemClassification.useful, 0x0047),
    ("Gear Customization: Auto-Reflect",       ItemClassification.useful, 0x0048),
    ("Gear Customization: Auto-Haste",         ItemClassification.useful, 0x0049),
    ("Gear Customization: Auto-Regen",         ItemClassification.useful, 0x004A),
    ("Gear Customization: Strength +3%",       ItemClassification.filler, 0x004B),
    ("Gear Customization: Strength +5%",       ItemClassification.filler, 0x004C),
    ("Gear Customization: Strength +10%",      ItemClassification.useful, 0x004D),
    ("Gear Customization: Strength +20%",      ItemClassification.useful, 0x004E),
    ("Gear Customization: Magic +3%",          ItemClassification.filler, 0x004F),
    ("Gear Customization: Magic +5%",          ItemClassification.filler, 0x0050),
    ("Gear Customization: Magic +10%",         ItemClassification.useful, 0x0051),
    ("Gear Customization: Magic +20%",         ItemClassification.useful, 0x0052),
    ("Gear Customization: Defense +3%",        ItemClassification.filler, 0x0053),
    ("Gear Customization: Defense +5%",        ItemClassification.filler, 0x0054),
    ("Gear Customization: Defense +10%",       ItemClassification.useful, 0x0055),
    ("Gear Customization: Defense +20%",       ItemClassification.useful, 0x0056),
    ("Gear Customization: Magic Def +3%",      ItemClassification.filler, 0x0057),
    ("Gear Customization: Magic Def +5%",      ItemClassification.filler, 0x0058),
    ("Gear Customization: Magic Def +10%",     ItemClassification.useful, 0x0059),
    ("Gear Customization: Magic Def +20%",     ItemClassification.useful, 0x005A),
    ("Gear Customization: HP +5%",             ItemClassification.filler, 0x005B),
    ("Gear Customization: HP +10%",            ItemClassification.filler, 0x005C),
    ("Gear Customization: HP +20%",            ItemClassification.useful, 0x005D),
    ("Gear Customization: HP +30%",            ItemClassification.useful, 0x005E),
    ("Gear Customization: MP +5%",             ItemClassification.filler, 0x005F),
    ("Gear Customization: MP +10%",            ItemClassification.filler, 0x0060),
    ("Gear Customization: MP +20%",            ItemClassification.useful, 0x0061),
    ("Gear Customization: MP +30%",            ItemClassification.useful, 0x0062),
    ("Gear Customization: Counterattack",      ItemClassification.useful, 0x0063),
    ("Gear Customization: Evade & Counter",    ItemClassification.useful, 0x0064),
    ("Gear Customization: Magic Counter",      ItemClassification.useful, 0x0065),
    ("Gear Customization: Magic Booster",      ItemClassification.useful, 0x0066),
    ("Gear Customization: Alchemy",            ItemClassification.useful, 0x0067),
    ("Gear Customization: Auto-Potion",        ItemClassification.useful, 0x0068),
    ("Gear Customization: Auto-Med",           ItemClassification.useful, 0x0069),
    ("Gear Customization: Auto-Phoenix",       ItemClassification.useful, 0x006A),
    ("Gear Customization: Half MP Cost",       ItemClassification.useful, 0x006B),
    ("Gear Customization: One MP Cost",        ItemClassification.useful, 0x006C),
    ("Gear Customization: Double AP",          ItemClassification.useful, 0x006D),
    ("Gear Customization: Triple AP",          ItemClassification.useful, 0x006E),
    ("Gear Customization: Overdrive to AP",    ItemClassification.useful, 0x006F),
    ("Gear Customization: SOS Overdrive",      ItemClassification.useful, 0x0070),
    ("Gear Customization: Double Overdrive",   ItemClassification.useful, 0x0071),
    ("Gear Customization: Triple Overdrive",   ItemClassification.useful, 0x0072),
    ("Gear Customization: Gillionaire",        ItemClassification.useful, 0x0073),
    ("Gear Customization: Pickpocket",         ItemClassification.useful, 0x0074),
    ("Gear Customization: Master Thief",       ItemClassification.useful, 0x0075),
    ("Gear Customization: HP Stroll",          ItemClassification.filler, 0x0076),
    ("Gear Customization: MP Stroll",          ItemClassification.filler, 0x0077),
    ("Gear Customization: No Encounters",      ItemClassification.useful, 0x0078),
    ("Gear Customization: Break MP Limit",     ItemClassification.useful, 0x0079),
    ("Gear Customization: Break HP Limit",     ItemClassification.useful, 0x007A),
    ("Gear Customization: Break Damage Limit", ItemClassification.useful, 0x007B),
    ("Gear Customization: Ribbon",             ItemClassification.useful, 0x007C),

    ("Aeon Customization: Dark Attack",     ItemClassification.useful, 0x0000 + 0x7D),
    ("Aeon Customization: Silence Attack",  ItemClassification.useful, 0x0001 + 0x7D),
    ("Aeon Customization: Sleep Attack",    ItemClassification.useful, 0x0002 + 0x7D),
    ("Aeon Customization: Dark Buster",     ItemClassification.useful, 0x0003 + 0x7D),
    ("Aeon Customization: Silence Buster",  ItemClassification.useful, 0x0004 + 0x7D),
    ("Aeon Customization: Sleep Buster",    ItemClassification.useful, 0x0005 + 0x7D),
    ("Aeon Customization: Zombie Attack",   ItemClassification.useful, 0x0006 + 0x7D),
    ("Aeon Customization: Triple Foul",     ItemClassification.useful, 0x0007 + 0x7D),
    ("Aeon Customization: Delay Attack",    ItemClassification.useful, 0x0008 + 0x7D),
    ("Aeon Customization: Delay Buster",    ItemClassification.useful, 0x0009 + 0x7D),
    #("Aeon Customization: Extract Power",   ItemClassification.useful, 0x000A + 0x7D),
    #("Aeon Customization: Extract Mana",    ItemClassification.useful, 0x000B + 0x7D),
    #("Aeon Customization: Extract Speed",   ItemClassification.useful, 0x000C + 0x7D),
    #("Aeon Customization: Extract Ability", ItemClassification.useful, 0x000D + 0x7D),
    ("Aeon Customization: Power Break",     ItemClassification.useful, 0x000E + 0x7D),
    ("Aeon Customization: Magic Break",     ItemClassification.useful, 0x000F + 0x7D),
    ("Aeon Customization: Armor Break",     ItemClassification.useful, 0x0010 + 0x7D),
    ("Aeon Customization: Mental Break",    ItemClassification.useful, 0x0011 + 0x7D),
    ("Aeon Customization: Full Break",      ItemClassification.useful, 0x0012 + 0x7D),
    ("Aeon Customization: Pray",            ItemClassification.filler, 0x0013 + 0x7D),
    ("Aeon Customization: Cheer",           ItemClassification.filler, 0x0014 + 0x7D),
    ("Aeon Customization: Aim",             ItemClassification.filler, 0x0015 + 0x7D),
    ("Aeon Customization: Focus",           ItemClassification.filler, 0x0016 + 0x7D),
    ("Aeon Customization: Reflex",          ItemClassification.filler, 0x0017 + 0x7D),
    ("Aeon Customization: Luck",            ItemClassification.filler, 0x0018 + 0x7D),
    ("Aeon Customization: Jinx",            ItemClassification.filler, 0x0019 + 0x7D),
    ("Aeon Customization: Lancet",          ItemClassification.filler, 0x001A + 0x7D),
    ("Aeon Customization: Doublecast",      ItemClassification.useful, 0x001B + 0x7D),
    ("Aeon Customization: Cure",            ItemClassification.useful, 0x001C + 0x7D),
    ("Aeon Customization: Cura",            ItemClassification.useful, 0x001D + 0x7D),
    ("Aeon Customization: Curaga",          ItemClassification.useful, 0x001E + 0x7D),
    ("Aeon Customization: NulBlaze",        ItemClassification.useful, 0x001F + 0x7D),
    ("Aeon Customization: NulShock",        ItemClassification.useful, 0x0020 + 0x7D),
    ("Aeon Customization: NulTide",         ItemClassification.useful, 0x0021 + 0x7D),
    ("Aeon Customization: NulFrost",        ItemClassification.useful, 0x0022 + 0x7D),
    ("Aeon Customization: Scan",            ItemClassification.filler, 0x0023 + 0x7D),
    ("Aeon Customization: Life",            ItemClassification.useful, 0x0024 + 0x7D),
    ("Aeon Customization: Full-Life",       ItemClassification.useful, 0x0025 + 0x7D),
    ("Aeon Customization: Haste",           ItemClassification.useful, 0x0026 + 0x7D),
    ("Aeon Customization: Hastega",         ItemClassification.useful, 0x0027 + 0x7D),
    ("Aeon Customization: Slow",            ItemClassification.useful, 0x0028 + 0x7D),
    ("Aeon Customization: Slowga",          ItemClassification.useful, 0x0029 + 0x7D),
    ("Aeon Customization: Shell",           ItemClassification.useful, 0x002A + 0x7D),
    ("Aeon Customization: Protect",         ItemClassification.useful, 0x002B + 0x7D),
    ("Aeon Customization: Reflect",         ItemClassification.useful, 0x002C + 0x7D),
    ("Aeon Customization: Dispel",          ItemClassification.useful, 0x002D + 0x7D),
    ("Aeon Customization: Regen",           ItemClassification.useful, 0x002E + 0x7D),
    ("Aeon Customization: Holy",            ItemClassification.useful, 0x002F + 0x7D),
    ("Aeon Customization: Fire",            ItemClassification.useful, 0x0030 + 0x7D),
    ("Aeon Customization: Thunder",         ItemClassification.useful, 0x0031 + 0x7D),
    ("Aeon Customization: Water",           ItemClassification.useful, 0x0032 + 0x7D),
    ("Aeon Customization: Blizzard",        ItemClassification.useful, 0x0033 + 0x7D),
    ("Aeon Customization: Fira",            ItemClassification.useful, 0x0034 + 0x7D),
    ("Aeon Customization: Thundara",        ItemClassification.useful, 0x0035 + 0x7D),
    ("Aeon Customization: Watera",          ItemClassification.useful, 0x0036 + 0x7D),
    ("Aeon Customization: Blizzara",        ItemClassification.useful, 0x0037 + 0x7D),
    ("Aeon Customization: Firaga",          ItemClassification.useful, 0x0038 + 0x7D),
    ("Aeon Customization: Thundaga",        ItemClassification.useful, 0x0039 + 0x7D),
    ("Aeon Customization: Waterga",         ItemClassification.useful, 0x003A + 0x7D),
    ("Aeon Customization: Blizzaga",        ItemClassification.useful, 0x003B + 0x7D),
    ("Aeon Customization: Bio",             ItemClassification.useful, 0x003C + 0x7D),
    ("Aeon Customization: Demi",            ItemClassification.useful, 0x003D + 0x7D),
    ("Aeon Customization: Death",           ItemClassification.useful, 0x003E + 0x7D),
    ("Aeon Customization: Drain",           ItemClassification.useful, 0x003F + 0x7D),
    ("Aeon Customization: Osmose",          ItemClassification.useful, 0x0040 + 0x7D),
    ("Aeon Customization: Flare",           ItemClassification.useful, 0x0041 + 0x7D),
    ("Aeon Customization: Ultima",          ItemClassification.useful, 0x0042 + 0x7D),
    #("Aeon Customization: HP +100",         ItemClassification.useful, 0x0043 + 0x7D),
    #("Aeon Customization: MP +10",          ItemClassification.useful, 0x0044 + 0x7D),
    #("Aeon Customization: STR +1",          ItemClassification.useful, 0x0045 + 0x7D),
    #("Aeon Customization: DEF +1",          ItemClassification.useful, 0x0046 + 0x7D),
    #("Aeon Customization: MAG +1",          ItemClassification.useful, 0x0047 + 0x7D),
    #("Aeon Customization: MDF +1",          ItemClassification.useful, 0x0048 + 0x7D),
    #("Aeon Customization: AGI +1",          ItemClassification.useful, 0x0049 + 0x7D),
    #("Aeon Customization: LCK +1",          ItemClassification.useful, 0x004A + 0x7D),
    #("Aeon Customization: EVA +1",          ItemClassification.useful, 0x004B + 0x7D),
    #("Aeon Customization: ACC +1",          ItemClassification.useful, 0x004C + 0x7D),
]]
...
AllItems = list(chain(generated_normal_items,
                      key_items,
                      equip_items,
                      party_member_items,
                      region_unlock_items,
