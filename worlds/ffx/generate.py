...
def generate_output(world: FFXWorld, player: int, output_directory: str) -> None:
    options_data = {
        ...
        "CaptureRequirement":   0 if not world.options.capture_sanity.value \
                                else max(1, world.options.creation_rewards.value, world.options.arena_bosses.value),
        ...
        "CustomizationRecipes": world.options.customization_recipes.value,
